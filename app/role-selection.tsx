...
const roleOptions = [
  {
    ...
    title: "Luxury Renter",
    description:
      "Discover and book exclusive luxury properties for short or long-term stays",
    icon: "🏖️",
  },
  {
    id: "homeowner",
    ...
    description:
      "List and manage your luxury properties for rental and investment opportunities",
    icon: "🏛️",
  },
];
