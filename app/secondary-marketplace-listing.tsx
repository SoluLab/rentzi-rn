...
export default function SecondaryMarketplaceListingScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const totalValue = parseInt(formData.numberOfTokens) * parseFloat(formData.pricePerToken);
      
      Alert.alert(
        'Listing Created Successfully',
        `Your ${formData.numberOfTokens} tokens have been listed for $${totalValue.toLocaleString()} total value.`,
        [
          {
            text: 'OK',
            onPress: () => router.back(),
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Header
        title="List Tokens"
        subtitle="Create a listing for your tokens"
        showBackButton={true}
      />
      ...
      >
          ...
          <Card style={styles.headerCard}>
            <View style={styles.headerContent}>
              ...
              <View style={styles.headerText}>
                <Typography variant="h4">Secondary Marketplace</Typography>
          ...
          <Card style={styles.formCard}>
            ...
            <View style={styles.inputSection}>
              ...
              <Input
                ...
                onChangeText={(value) => handleInputChange('tokenName', value)}
              ...
              <View style={styles.summaryGrid}>
                ...
                <View style={styles.summaryItem}>
                  ...
                  <Typography variant="h4">
                    ${parseFloat(formData.pricePerToken || '0').toLocaleString()}
                  </Typography>
                </View>
              </View>
        ...
        <View style={styles.actionBar}>
          <Button
            ...
            disabled={!formData.tokenName || !formData.numberOfTokens || !formData.pricePerToken}
