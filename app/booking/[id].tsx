...
import { ArrowLeft, Calendar, Users, CreditCard, CheckCircle, Edit3 } from 'lucide-react-native';
            ...
            >
                <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                    ...
                    <Card style={styles.bookingCard}>
                        ...
                        <View style={styles.dateSection}>
                            <View style={styles.dateRow}>
                                ...
                                {datesFromCalendar && (
                                    <TouchableOpacity onPress={handleEditDates} style={styles.editDatesButton}>
                    ...
                    <Card style={styles.summaryCard}>
                        ...
                        <View style={styles.summaryRow}>
                            <Typography variant="body">60 tokens/night × {calculateNights()} nights</Typography>
                            <Typography variant="body">
                        ...
                        <View style={styles.tokenNote}>
                            <Typography variant="caption" color="secondary" style={styles.noteText}>
                                Note: These tokens include convenience fee and taxes also.
                            </Typography>
                        </View>
