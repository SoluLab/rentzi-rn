...
const CONSENT_ITEMS = [
  {
    ...
    details: 'Residential real estate investments carry inherent risks including market volatility, economic downturns, and property-specific challenges. I acknowledge that property values and rental income may fluctuate.',
  },
  {
  ...
  },
  {
    ...
    description: 'I consent to tokenize or fractionalize my property if selected',
    details: 'I authorize the platform to create digital tokens representing fractional ownership of my property if I choose this option. This process involves legal and technical considerations for digital asset creation.',
  },
  {
    key: 'usageRights' as keyof ConsentData,
    title: 'Usage Rights Agreement',
    description: 'I agree to usage rights (e.g., nights, cash flow rights)',
    details: 'I agree to the platform\'s usage rights model, which may include revenue sharing arrangements, operational requirements, and property management guidelines.',
  },
  {
    key: 'liquidityLimitations' as keyof ConsentData,
    title: 'Liquidity Limitations',
    description: 'I understand liquidity limitations and lock-in',
...
export default function ResidentialPropertyLegalConsentsScreen() {
  ...
  const handleNext = () => {
    if (validateForm()) {
      ...
      router.push({
        pathname: '/add-residential-details/residential-property-listing-purpose',
        params: {
          propertyTitle,
